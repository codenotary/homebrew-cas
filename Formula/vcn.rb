class Vcn < Formula
    ...
    version "v0.9.9"
    if OS.mac?
        url "https://github.com/codenotary/vcn/releases/download/#{version}/vcn-#{version}-darwin-amd64"
        sha256 "d39824501bfe6e3ffcc91c4cf458650ba4f3a86a3f7f57e2209d5de7aac246de"
    elsif OS.linux?
        url "https://github.com/codenotary/vcn/releases/download/#{version}/vcn-#{version}-linux-amd64"
